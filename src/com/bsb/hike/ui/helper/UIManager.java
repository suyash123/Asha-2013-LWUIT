 ...
 * @author Sudheer Keshav Bhat - Using EmoticonLookAndFeel as DefaultLookAndFeel.
 */
public class UIManager {

    private DefaultLookAndFeel current = new EmoticonLookAndFeel();
     ...
     */
    public DefaultLookAndFeel getLookAndFeel() {
        return current;
    }
     ...
     */
    public void setLookAndFeel(DefaultLookAndFeel plaf) {
        current.uninstall();
        current = plaf;
    }
            ...
            if (bgImage != null) {
                ...
                if (bgImage instanceof String) {
                    try {
                        ...
                        Log.v(TAG, "failed to parse image for id = " + id + Style.BG_IMAGE);
                    }
                } else {
